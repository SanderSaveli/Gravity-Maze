...
namespace SanderSaveli.GravityMaze.Editor
{
    [CustomEditor(typeof(SelfPathMover))]
    public class SelfPathMoverEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            SelfPathMover mover = (SelfPathMover)target;
